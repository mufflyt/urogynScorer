#' PFDI-20 Sample Dataset
#'
#' This is a sample dataset containing Pelvic Floor Distress Inventory (PFDI-20)
#' responses along with patient identifiers and clinical measurements.
#'
