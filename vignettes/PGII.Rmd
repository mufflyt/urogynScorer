...
* **Validity**: Strong correlation with condition-specific quality of life measures [@yalcin2003]
...
The PGI-I scale evolved from the Clinical Global Impression (CGI) scales originally developed for psychiatric research. In 2003, Yalcin and Bump [@yalcin2003] validated the PGI-I specifically for women with urinary incontinence, demonstrating its:
...
The minimal important difference (MID) for the PGI-I has been established in studies as a score of ≤2 ("much better" or "very much better"), indicating clinically significant improvement [@srikrishna2010]. This threshold is commonly used to define "responders" in clinical trials and has been shown to correspond with meaningful improvements in quality of life measures.
...
(p1 | p3) / p2 + 
  plot_annotation(
    title = "Comprehensive Treatment Outcome Assessment",
    subtitle = "Comparing subjective (PGI-I) and objective (PFDI-20) measures",
    theme = theme(plot.title = element_text(size = 16, face = "bold"),
                  plot.subtitle = element_text(size = 12, face = "italic"))
  )
```

## 6.1 Key Findings from the Case Study

1. **Concordance between measures**: Patients with greater PFDI-20 improvement tend to report better PGI-
